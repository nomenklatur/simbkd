<section class="content">
      <div class="row">
        <div class="col-9">
          <div class="card">
            <div class="card-body">
            <form role="form" enctype="multipart/form-data" method="POST" action="<?=base_url()?>Dosen/editPendidikan/<?=$pendidikan[0]->id?>/<?=$tahunS?>/do_edit">
                <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" name="bukti_kegiatan_bk" ><?=$pendidikan[0]->bukti_penugasan_bk?></textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="sks_bk" value="<?=$pendidikan[0]->sks_bk?>">
                  </div>
                  <div class="form-group"  align="center">
                    <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                  </div>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Bukti Kegiatan</label>
                    <textarea type="text" class="form-control" name="bukti_kegiatan_k" ><?=$pendidikan[0]->bukti_penugasan_k?></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">File Bukti Kegiatan</label>
                        <div class="custom-file">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="persen" value="<?=$pendidikan[0]->persen_capaian?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Sks</label>
                    <input type="text" class="form-control" name="sks_k" value="<?=$pendidikan[0]->sks_capaian?>">
                  </div>
                </div>
                <!-- /.card-body -->
