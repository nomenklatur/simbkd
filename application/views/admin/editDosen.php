          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="form-group">
                <form enctype="multipart/form-data" class="form-horizontal" method="POST"  action="<?=base_url()?>Admin/editFoto/<?=$dosen[0]->id?>/do_edit">
            ...
            <form enctype="multipart/form-data" class="form-horizontal" method="POST"  action="<?=base_url()?>Admin/editDosen/<?=$dosen[0]->id?>/do_edit">
            </div>
            <!-- /.card-body -->
                </ul>
              </div>
            ...
            <div class="card">
              ...
              <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail2" class="col-sm-2 col-form-label">Username</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputEmail2" name="username" value="<?=$dosen[0]->username?>" placeholder="username">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <a href="<?=base_url()?>Admin/dosen" type="submit" class="btn btn-default ">Batal</a>
                    </div>
                    <!-- /.card-footer -->
                    </form>
              </div><!-- /.card-body -->
