          ...
          <div class="col-md-3">
            ...
            <div class="card">
              ...
              <table class="table ">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?= base_url()?>Admin/file/<?=$dosen[0]->ijazah_s1?>" class="btn btn-primary" target="_blank"><i class="far fa-file"> File Ijazah S1</i></a></td>
                        <?php }else{?>
                          File belum diunggah
                        <?php }?>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?= base_url()?>Admin/file/<?=$dosen[0]->transkrip_s1?>" class="btn btn-primary" target="_blank"><i class="far fa-file"> File Transkrip S1</i></a></td>
                        <?php }else{?>
                          File belum diunggah
                        <?php }?>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?= base_url()?>Admin/file/<?=$dosen[0]->ijazah_s2?>" class="btn btn-primary" target="_blank"><i class="far fa-file"> File Ijazah S2</i></a></td>
                        <?php }else{?>
                          File belum diunggah
                        <?php }?>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?= base_url()?>Admin/file/<?=$dosen[0]->transkrip_s2?>" class="btn btn-primary" target="_blank"><i class="far fa-file"> File Transkrip S2</i></a></td>
                        <?php }else{?>
                          File belum diunggah
                        <?php }?>
                    </tr>
                    ...
                    <tr>
                      ...
                      <?php if($dosen[0]->ijazah_s3 != null || $dosen[0]->ijazah_s3!= ""){?>
                        <a href="<?= base_url()?>Admin/file/<?=$dosen[0]->ijazah_s3?>" class="btn btn-primary" target="_blank"><i class="far fa-file"> File Ijazah S3</i></a></td>
                        <?php }else{?>
                          File belum diunggah
                        <?php }?>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?= base_url()?>Admin/file/<?=$dosen[0]->transkrip_s3?>" class="btn btn-primary" target="_blank"><i class="far fa-file"> File Transkrip S3</i></a></td>
                        <?php }else{?>
                          File belum diunggah
                        <?php }?>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?= base_url()?>Admin/file/<?=$dosen[0]->file_jenis_dosen?>" class="btn btn-primary" target="_blank"><i class="far fa-file"> File Jenis Dosen</i></a></td>
                        <?php }else{?>
                          File belum diunggah
                        <?php }?>
                    </tr>
                    ...
                    <tr>
                      ...
                      <?php if($dosen[0]->sptjm != null || $dosen[0]->sptjm!= ""){?>  
                        <a href="<?= base_url()?>Admin/file/<?=$dosen[0]->sptjm?>" class="btn btn-primary" target="_blank"><i class="far fa-file"> File SPTJM</i></a>
                      <?php }else{?>
                        File belum diunggah
                      <?php }?>
                      </td>
                    ...
                    <tr>
                      <td width="40%">SPTJM DOSEN</td>
                      <td width="20px">:</td>
                      <td>
                      <?php if($dosen[0]->sptjm_dosen != null || $dosen[0]->sptjm_dosen!= ""){?>  
                        <a href="<?= base_url()?>Admin/file/<?=$dosen[0]->sptjm_dosen?>" class="btn btn-primary" target="_blank"><i class="far fa-file"> File SPTJM</i></a>
                      <?php }else{?>
                        File belum diunggah
                      <?php }?>
                      </td>
                    ...
                    <tr>
                      <td width="40%">SPTJM PIMPINAN</td>
                      <td width="20px">:</td>
                      <td>
                      <?php if($dosen[0]->sptjm_pimpinan != null || $dosen[0]->sptjm_pimpinan!= ""){?>  
                        <a href="<?= base_url()?>Admin/file/<?=$dosen[0]->sptjm_pimpinan?>" class="btn btn-primary" target="_blank"><i class="far fa-file"> File SPTJM</i></a>
                      <?php }else{?>
                        File belum diunggah
                      <?php }?>
                      </td>
                    ...
                    <tr>
                      <td width="40%">PERNYATAAN ASESOR</td>
                      <td width="20px">:</td>
                      <td>
                      <?php if($dosen[0]->pertnyataan_as != null || $dosen[0]->pertnyataan_as!= ""){?>  
                        <a href="<?= base_url()?>Admin/file/<?=$dosen[0]->pertnyataan_as?>" class="btn btn-primary" target="_blank"><i class="far fa-file"> File SPTJM</i></a>
                      <?php }else{?>
                        File belum diunggah
                      <?php }?>
                      </td>
                ...
                <a href="<?=base_url()?>Admin/editDosen/<?= $dosen[0]->id?>" type="button" class="btn btn-primary btn-sm float-right"><i class="fas fa-edit"> Edit Dosen</i></a>
              </div><!-- /.card-body -->
            </div>
            <!-- /.nav-tabs-custom -->
          </div>
