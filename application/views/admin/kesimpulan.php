        ...
        <div class="col-9">
          <div class="card">
            ...
            <div class="card-header">
                     <a href="<?=base_url()?>Admin/cetakKesimpulan/<?=$dosen[0]->id?>/<?=$tahun[0]->id?>"  class="btn btn-primary float-right" ><i class="fas fa-print">Kesimpulan Dosen</i></a>
                     <a href="<?=base_url()?>Admin/cetakNilai2/<?=$dosen[0]->id?>/<?=$tahun[0]->id?>"  class="btn btn-primary float-right" ><i class="fas fa-print">Kesimpulan Asesor II</i></a>
                     <a href="<?=base_url()?>Admin/cetakNilai1/<?=$dosen[0]->id?>/<?=$tahun[0]->id?>"  class="btn btn-primary float-right" ><i class="fas fa-print">Kesimpulan Asesor I</i></a>
                     <a href="<?=base_url()?>Admin/cetakBkd/<?=$dosen[0]->id?>/<?=$tahun[0]->id?>"  class="btn btn-success float-right" ><i class="fas fa-print"> Cetak BKD</i></a>
            </div>
            <table class="table ">
                  <tbody>
                    <tr>
