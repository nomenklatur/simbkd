        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Penyataan Asesor</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
            <form role="form" enctype="multipart/form-data" method="POST" action="<?=base_url()?>Asesor/uploadFile1/<?=$id?>">
                <div class="form-group row">
                        <label for="src1" class="col-sm-2 col-form-label">Pilih File</label>
                        <div class="col-sm-10">
                            <div class="custom-file">
                                <input type="file" id="src1"  class="custom-file-input" name="pernyataanAs" id="">
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card card-primary card-outline card-outline-tabs">
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-four-tabContent">
                  <div class="tab-pane fade <?=$this->session->active?> <?=$this->session->show?>" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                    ...
                    <a href="<?=base_url()?>Asesor/kePenelitian/<?=$id?>" class="btn btn-success btn-sm float-right"><i class="fas fa-arrow-right"> Selanjutnya</i></a>
                  </div>
                  ...
                  <table id="dtHorizontalExample1"class="table table-bordered table-striped" style="width: 100%;">
                    ...
                    <a href="<?=base_url()?>Asesor/kePengabdian/<?=$id?>"  class="btn btn-success btn-sm float-right" ><i class="fas fa-arrow-right"> Selanjutnya</i></a>
                    <a href="<?=base_url()?>Asesor/kePendidikan/<?=$id?>" class="btn btn-primary btn-sm float-right" ><i class="fas fa-arrow-left"> Sebelumnya</i></a>
                  </div>
                  ...
                  <thead>
                    ...
                    <a href="<?=base_url()?>Asesor/kePenunjang/<?=$id?>" class="btn btn-success btn-sm float-right" ><i class="fas fa-arrow-right"> Selanjutnya</i></a>
                    <a href="<?=base_url()?>Asesor/kePenelitian/<?=$id?>" class="btn btn-primary btn-sm float-right" ><i class="fas fa-arrow-left"> Sebelumnya</i></a>
                  </div>
                  ...
                  <thead>
                    ...
                    <a href="<?=base_url()?>Asesor/keKhusus/<?=$id?>" class="btn btn-success btn-sm float-right" ><i class="fas fa-arrow-right"> Selanjutnya</i></a>
                    <a href="<?=base_url()?>Asesor/kePengabdian/<?=$id?>" class="btn btn-primary btn-sm float-right" ><i class="fas fa-arrow-left"> Sebelumnya</i></a>
                  </div>
              ...
              <a href="<?=base_url()?>Asesor/kesimpulan/<?=$id?>/<?=$tahunS?>" class="btn btn-success btn-sm float-right"><i class="fas fa-arrow-right"> Kesimpulan</i></a>
                    <a href="<?=base_url()?>Asesor/keKhusus/<?=$id?>" class="btn btn-primary btn-sm float-right" ><i class="fas fa-arrow-left"> Sebelumnya</i></a>
                  ...
                  <table id="dtHorizontalExample4" class="table table-bordered table-striped" >
                      ...
                      <a href="<?=base_url()?>Asesor/keUpload/<?=$id?>" class="btn btn-success btn-sm float-right"><i class="fas fa-arrow-right"> Selanjutnya</i></a>
             
                    <a href="<?=base_url()?>Asesor/kePenunjang/<?=$id?>" class="btn btn-primary btn-sm float-right" ><i class="fas fa-arrow-left"> Sebelumnya</i></a>
                  </div>
                </div>
              </div>
              <!-- /.card -->
