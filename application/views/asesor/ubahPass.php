<section class="content">
      <div class="row">
        <div class="col-6">
          <div class="card">
            <div class="card-body">
            <form role="form" method="POST" action="<?=base_url()?>Asesor/ubahPass/<?=$asesor[0]->id?>/do_update">
                <div class="card-body">
                <div class="form-group">
                    <label for="exampleInputPassword1">Nama</label>
                    <input type="text" class="form-control" disabled value="<?=$asesor[0]->nama?>" placeholder="Password">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Password Lama</label>
                    <input type="password" class="form-control" disabled value="<?=$asesor[0]->pass_asli?>" placeholder="Password">
                  </div>
                  <div class="form-group">
